...
using Offence = TrafficCourts.Citizen.Service.Models.Offence;
using DBModelTicket = TrafficCourts.Citizen.Service.Features.Tickets.DBModel.Ticket;
...
using TrafficCourts.Citizen.Service.Features.Disputes.DBModel;

namespace TrafficCourts.Citizen.Service.Features.Tickets.Queries
