...
using static TrafficCourts.Citizen.Service.Features.AddressAutoComplete.AddressAutocompleteClient;

namespace TrafficCourts.Citizen.Service.Features.AddressAutoComplete
{
