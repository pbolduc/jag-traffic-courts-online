...
export class DisputeFormStateService extends AbstractFormStateService<TicketDisputeView> {
  ...
  public buildStepDisputantForm(): FormGroup {
    return this.formBuilder.group({
      ...
      postalCode: [null, [Validators.required, Validators.pattern("[ABCEGHJKLMNPRSTVXY][0-9][ABCEGHJKLMNPRSTVWXYZ] ?[0-9][ABCEGHJKLMNPRSTVWXYZ][0-9]")]],
      city: [null, [Validators.required]],
      country: [null, [Validators.required]],
      province: [null, [Validators.required]],
      _mailingAddress: [null],
      driverLicenseNumber: [null, [Validators.required, Validators.minLength(7), Validators.maxLength(7), Validators.pattern("^[0-9]*$")]],
      driverLicenseProvince: [null, Validators.required],
      emailAddress: [null, [Validators.required, Validators.email]],
      phoneNumber: [null, [FormControlValidators.phone, Validators.required]],
